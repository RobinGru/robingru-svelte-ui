...
export function previewFor(name: string): PreviewConfig {
  switch (name) {
    ...
    case 'Figure': return { props: { caption: 'Komponenten teilen dieselbe visuelle Grammatik.', credit: 'Design-System', aspect: '16 / 7', media: raw('<div style="height:100%;display:grid;grid-template-columns:repeat(3,1fr);gap:.75rem;padding:1.25rem;background:var(--rg-surface-sunken)"><div class="rg-card" style="display:grid;align-content:start;gap:.35rem;padding:.8rem"><small style="color:var(--rg-fg-muted)">Editorial</small><strong>Artikel</strong><span style="color:var(--rg-fg-muted);font-size:.75rem">Lesefluss und Kontext</span></div><div class="rg-card" style="display:grid;align-content:start;gap:.35rem;padding:.8rem;background:var(--rg-primary-soft)"><small style="color:var(--rg-fg-muted)">Dashboard</small><strong>84 %</strong><span style="color:var(--rg-fg-muted);font-size:.75rem">Im Zielbereich</span></div><div class="rg-card" style="display:grid;align-content:start;gap:.35rem;padding:.8rem"><small style="color:var(--rg-fg-muted)">Anwendung</small><strong>24</strong><span style="color:var(--rg-fg-muted);font-size:.75rem">Aktive Projekte</span></div></div>') }, code: importCode(name, '<Figure {media} caption="…" />') };
