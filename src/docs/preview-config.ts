...
export function previewFor(name: string): PreviewConfig {
  switch (name) {
    ...
    case 'ArticleHeader': return { props: { eyebrow: 'Design-System', title: 'Ein ruhiges Design-System', description: 'Eine ruhige Komponentenbasis für Apps, Dashboards und redaktionelle Inhalte.', align: 'start' }, code: importCode(name, '<ArticleHeader title="Ein ruhiges Design-System" />') };
