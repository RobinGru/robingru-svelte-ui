...
<AppShell>
  {#snippet sidebar()}
    <Sidebar>
      ...
      <div class="rg-nav-section">
        ...
        <a class="rg-nav-item" href="#catalog"><Settings size={17} />Katalog <Badge tone="primary">132</Badge></a>
      </div>

      {#snippet footer()}
        <div class="version-card">
          <span class="status-dot"></span>
          <div><strong>v0.3.1</strong><small>132 Komponenten · ohne VirtualTable</small></div>
        </div>
      {/snippet}
    </Sidebar>
  {/snippet}
  ...
  <div id="top" class="page-stack">
    <PageHeader
      ...
      description="132 aufeinander abgestimmte Svelte-Komponenten: ruhiges Robin Blue, klare Informationshierarchie und keine parallelen Komponentenbibliotheken."
    >
      {#snippet breadcrumbs()}
    ...
    <div class="release-strip" id="catalog">
      <div><strong>132</strong><span>eindeutige Komponenten</span></div>
