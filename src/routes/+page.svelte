<script lang="ts">
  ...
  const featureCards = [
    { icon: Component, title: '132 abgestimmte Komponenten', text: 'Grundlagen, Formulare, Navigation, Daten, Dashboard und Editorial in einer gemeinsamen Sprache.' },
  ...
  const routes = [
    { icon: Component, href: '/components', title: 'Komponenten', text: 'Alle Komponenten live, filterbar und mit eigener Detailseite.', meta: '132 Live-Previews' },
...
<svelte:head>
  ...
  <meta name="description" content="RobinGru Svelte UI: 132 live dokumentierte Svelte-Komponenten für Anwendungen, Dashboards, Datentabellen und Editorial Content." />
</svelte:head>
