...
if (componentFiles.length !== 131) errors.push(`Expected 131 packaged Svelte components, found ${componentFiles.length}.`);
...
if (componentExports.length !== 131) errors.push(`Expected 131 public component exports in dist/index.js, found ${componentExports.length}.`);
